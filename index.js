...
const server = http.createServer(async (req, res) => { // async callback 
  ...
  if (req.url === '/') {
    ...
    if (percentage == 0 && icon === "src/icons/bronze_01.png") { // Unranked
      htmlContent = `<!DOCTYPE html><html><head><style>@font-face {font-family: "Burbank Big Condensed Bold";src: url('/font.ttf');}.container {background-size: cover;position: relative;text-align: center;color: rgb(255, 255, 255);}.text {position: absolute;font-size: 19px;left: 399px;top: 9px;font-family: "Burbank Big Condensed Bold", sans-serif;transform: scaleX(0.80);letter-spacing: 1px;}.image-container {position: relative;left: 50px}.precent {position: relative;left: 50px}.image-rank {position: absolute;top: -1px;left: 20px;z-index: 3;width: 44px;height: 44px;}.image-percent {position: absolute;top: 0;left: 0;z-index: 1;width: 352px;height: 43px;clip-path: polygon(0 0, 342px 0, 342px 100%, 0 100%); /* Crop the width */}.image-transparent {position: absolute;top: 0;left: 0;z-index: 0;}.image-current {position: absolute;top: 0;left: 0px;z-index: 3;}</style></head><body><div><div class="rank"><img class="image-rank" src="src/icons/Unranked.png"></div><div class="image-container"><img class="image-current" src="src/bars/Unranked_current.png"><img class="image-percent" src="src/bars/Unranked_percentage.png"><img class="image-transparent" src="src/transparent.png"></div><div class="percent"><div class="container"><div class="text"></div></div></div></body></html>`;
    } else if (percentage < 2.4) { // Prevent Bar from rendering incorrectly under 2.4%
      htmlContent = `<!DOCTYPE html><html><head><style>@font-face {font-family: "Burbank Big Condensed Bold";src: url('/font.ttf');}.container {background-size: cover;position: relative;text-align: center;color: rgb(255, 255, 255);}.text {position: absolute;font-size: 19px;left: 399px;top: 9px;font-family: "Burbank Big Condensed Bold", sans-serif;transform: scaleX(0.80);letter-spacing: 1px;}.image-container {position: relative;left: 50px}.precent {position: relative;left: 50px}.image-rank {position: absolute;top: -1px;left: 20px;z-index: 3;width: 44px;height: 44px;}.image-percent {position: absolute;top: 0;left: 0;z-index: 1;width: 352px;height: 43px;clip-path: polygon(0 0, ${9 + convertedpercentage}px 0, ${9 + convertedpercentage}px 100%, 0 100%); /* Crop the width */}.image-transparent {position: absolute;top: 0;left: 0;z-index: 0;}.image-current {position: absolute;top: 0;left: ${0 - (342 - convertedpercentage - 9)}px;z-index: 3;}</style></head><body><div><div class="rank"><img class="image-rank" src="${icon}"></div><div class="image-container"><img class="image-transparent" src="src/transparent.png"></div><div class="percent"><div class="container"><div class="text">${percentage + '%'}</div></div></div></body></html>`;
    } else if (icon === "src/icons/Unreal.png") { // Unreal
      htmlContent = `<!DOCTYPE html><html><head><style>@font-face {font-family: "Burbank Big Condensed Bold";src: url('/font.ttf');}.container {background-size: cover;position: relative;text-align: center;color: rgb(255, 255, 255);}.text {position: absolute;font-size: 19px;left: 399px;top: 9px;font-family: "Burbank Big Condensed Bold", sans-serif;transform: scaleX(0.80);letter-spacing: 1px;}.image-container {position: relative;left: 50px}.precent {position: relative;left: 50px}.image-rank {position: absolute;top: -1px;left: 20px;z-index: 3;width: 44px;height: 44px;}.image-percent {position: absolute;top: 0;left: 0;z-index: 1;width: 352px;height: 43px;clip-path: polygon(0 0, ${9 + convertedpercentage}px 0, ${9 + convertedpercentage}px 100%, 0 100%); /* Crop the width */}.image-transparent {position: absolute;top: 0;left: 0;z-index: 0;}.image-current {position: absolute;top: 0;left: ${0 - (342 - convertedpercentage - 9)}px;z-index: 3;}</style></head><body><div><div class="rank"><img class="image-rank" src="${icon}"></div><div class="image-container"><img class="image-current" src="${rank.rankBar}_current.png"><img class="image-percent" src="${rank.rankBar}_percentage.png"><img class="image-transparent" src="src/transparent.png"></div><div class="percent"><div class="container"><div class="text">${percentage}</div></div></div></body></html>`;
